...
export default async function KnowledgeHubPage() {
  ...
  return <>
    ...
    <section className="card overflow-hidden" aria-labelledby="module-one-title">
      <div className="bg-[#143d2c] p-6 text-white sm:p-8"><div className="flex flex-wrap items-center justify-between gap-3"><p className="text-xs font-black uppercase tracking-[.16em] text-[#9ed6b9]">Fundamentos da Fé · Módulo 1</p><span className="badge bg-[#e6c861] text-[#19382b]">Aprovado · em preparação</span></div><h2 id="module-one-title" className="mt-3 text-3xl font-black">Conhecendo a Bíblia</h2><p className="mt-2 text-lg text-white/75">A Palavra que guia</p><div className="mt-5 flex flex-wrap gap-3 text-sm"><span className="rounded-full bg-white/10 px-3 py-1.5">3 aulas</span><span className="rounded-full bg-white/10 px-3 py-1.5">2 horas</span><span className="rounded-full bg-white/10 px-3 py-1.5">{ADOLESCENT_MIN_AGE}–{ADOLESCENT_MAX_AGE} anos</span></div></div>
