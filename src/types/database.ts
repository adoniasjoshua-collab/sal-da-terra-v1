...
export type EventHeadcountRow = { id:string;ministry_id:string;event_id:string;adolescent_count:number;visitor_count:number;is_estimated:boolean;notes:string|null;registered_by:string|null;created_at:string;updated_at:string };
...
export type ReportSignatoryRow = { id:string;ministry_id:string;full_name:string;role_title:string;phone:string|null;email:string|null;display_order:number;is_active:boolean;created_by:string|null;created_at:string;updated_at:string };
