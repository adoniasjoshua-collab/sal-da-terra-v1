...
export type EventType = "EBD" | "worship" | "evangelism" | "rehearsal" | "outing" | "congress" | "meeting";
...
export type EventRow = { id:string;ministry_id:string;title:string;type:EventType;event_date:string;start_time:string|null;description:string|null;status:EventStatus;created_by:string|null;created_at:string;updated_at:string };
